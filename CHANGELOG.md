...
- First public release. MCP server and CLI that turns an idea into a finished, published article in the author's own voice — Ghost and WordPress, persona-driven, with a photographic image contract and write-back verification on every publish.
